@extends('_layouts.master', [ 'locale' => 'fr_CA', 'disable_search' => true])
@section('body')
@include('_partials.header', ['title' => 'Documentation', 'text' => 'Que pouvons-nous faire pour vous aider?'])
...
<div class="container px-8 my-10 md:mx-auto">
    ...
    <div class="grid place-items-center py-10 w-1/2">
        <div class="search-wrapper"  id="search-box">
            <input type="text" id="search-input" placeholder="Recherchez Invoice Ninja" class="h-16 text-lg border-2 border-gray-300 focus:outline-none block w-full rounded-mdsm:max-w-xs py-2 px-6">
    ...
    <ul role="list" class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        ...
        <li class="col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-white text-center shadow border-t-4" style="border-color: rgb(84, 180, 52);">
            <a href="/fr_CA/user-guide">
                <div class="flex flex-1 flex-col p-8">
                  ...
                  <h1 class="mt-6 text-lg font-medium text-gray-900">{{ $page->__('texts.user_guide', 'fr_CA') }}</h1>
                </div>
            </a>
        </li>
        ...
        <li class="col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-white text-center shadow border-t-4" style="border-color: rgb(0, 128, 255);">
            <a href="/fr_CA/developer-guide">
                <div class="flex flex-1 flex-col p-8">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mx-auto h-32 w-32 flex-shrink-0">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" />
                    </svg>
                  <h1 class="mt-6 text-lg font-medium text-gray-900">{{ $page->__('texts.developer_resources', 'fr_CA') }}</h1>
                </div>
            </a>
        </li>
        ...
        <li class="col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-white text-center shadow border-t-4" style="border-color: rgb(255, 0, 0);">
            <a href="/fr_CA/getting-started/">
                <div class="flex flex-1 flex-col p-8">
                  ...
                  <h1 class="mt-6 text-lg font-medium text-gray-900">{{ $page->__('texts.self_host_installation', 'fr_CA') }}</h1>
                </div>
            </a>
        </li>
        ...
        <li class="col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-white text-center shadow border-t-4" style="border-color: rgb(255, 128, 0);">
            <a href="/fr_CA/migration">    
                <div class="flex flex-1 flex-col p-8">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mx-auto h-32 w-32 flex-shrink-0">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M12 16.5V9.75m0 0l3 3m-3-3l-3 3M6.75 19.5a4.5 4.5 0 01-1.41-8.775 5.25 5.25 0 0110.233-2.33 3 3 0 013.758 3.848A3.752 3.752 0 0118 19.5H6.75z" />
                    </svg>
                  <h1 class="mt-6 text-lg font-medium text-gray-900">{{ $page->__('texts.migrate_to_v5', 'fr_CA')}}</h1>
                </div>
            </a>   
        </li>
                ...
                <div class="flex flex-1 flex-col p-8">
                    ...
                    <h1 class="mt-6 text-lg font-medium text-gray-900">Slack</h1>
                        <dl class="mt-1 flex flex-grow flex-col justify-between">
                            <dd class="text-sm text-gray-500"><a href="http://slack.invoiceninja.com">Pas encore membre? Cliquez pour une invitation.</a></dd>
                      </dl>
                </div>
            </a>
        </li>
