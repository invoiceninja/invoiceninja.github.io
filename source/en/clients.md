...
Theis panel presents a view of the client's Company Details information listed in a client entry.

### Address

This panel presents the client's billing address. An alternate shipping address can also be entered in Client Edit, but will not be shown in this panel.
