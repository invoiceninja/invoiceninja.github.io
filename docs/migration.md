...
Installing v5 is covered in detail [here](/docs/self-host/self-host-installation) with resources to cover your needs for Docker / Shared Hosting or Ubuntu/Centos installations.
...
<div style={{position: "relative", paddingBottom: "56.25%", height: 0}}><iframe src="https://www.loom.com/embed/47a707f1624d425da74ab2fe33057941?sid=a6367087-9411-4894-b836-7fb5a3352bf2" frameBorder="0" allowFullScreen style={{position: "absolute", top: 0, left: 0, width: "100%", height: "100%"}}></iframe></div>
