...
Taxes can be configured manually by following the step [here](/en/user-guide/basic-settings/#tax_settings) where you can manually define the tax names, rates and how they are applied.
