...
<VideoPlayer src="/assets/videos/taxes/tax_configuration/tax_configuration_react.mpd" id="tax-configuration-video" />
...
<VideoPlayer src="/assets/videos/invoices/first_invoice/invoice_creation.mpd" id="invoice-creation-video" />
...
<VideoPlayer src="/assets/videos/payments/get_paid/get_paid.mpd" id="get-paid-video" />
