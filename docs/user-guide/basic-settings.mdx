...
If you're brand new, start with the walkthrough in [Get Started](/docs/user-guide) — it covers the same ground in the order you'll actually need it. When you're ready to dig deeper into templates, reminders, and custom fields, head over to [Advanced Settings](/docs/user-guide/advanced-settings).
